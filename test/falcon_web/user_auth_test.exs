defmodule FalconWeb.UserAuthTest do
  use FalconWeb.ConnCase, async: true

  alias Falcon.Accounts
  alias Falcon.Accounts.Scope
  alias FalconWeb.UserAuth

  import Falcon.AccountsFixtures

  @remember_me_cookie "_falcon_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, FalconWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
